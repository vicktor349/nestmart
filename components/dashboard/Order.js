            ...
            <div className="w-full">
                ...
                <div className="flex sm:flex-col lg:flex-row sm:items-center justify-between">
                    <ul className="flex max-sm:flex-col sm:items-center gap-x-14 gap-y-3">
                        <li className="font-medium text-lg leading-8 cursor-pointer text-primary transition-all duration-500 hover:text-primary">
                            All Order
                        </li>
                        <li className="font-medium text-lg leading-8 cursor-pointer transition-all duration-500 hover:text-primary">
                            Summary
                        </li>
                        <li className="font-medium text-lg leading-8 cursor-pointer transition-all duration-500 hover:text-primary">
                            Completed
                ...
                <div className="my-10 border border-gray-300">
                    ...
                    {orders.map((order) =>
                    {
                        ...
                        return (
                            <React.Fragment key={order.id}>
                                <div className="flex max-lg:flex-col items-center gap-8 lg:gap-24 px-3 md:px-11 py-8">
                                    ...
                                    <div className="flex items-center justify-around w-full sm:pl-28 lg:pl-0">
                                        <div className="flex flex-col justify-center items-start max-sm:items-center">
                                            ...
                                            <p className={`font-semibold text-lg leading-8 text-left whitespace-nowrap ${statusColor}`}>
                                                {order.status}
                                            </p>
                                        </div>
                                        <div className="flex flex-col justify-center items-start max-sm:items-center">
                    ...
                    <div className="px-3 md:px-11 flex justify-end max-sm:flex-col-reverse">
                        <p className="font-medium text-xl leading-8 text-black max-sm:py-4 py-8">
