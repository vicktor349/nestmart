                    ...
                    <div className='flex bottom-0 justify-center w-full'>
                        <div className="w-full ssm:h-[20rem] sm:h-[25rem] md:h-[27rem] lg:h-[33rem] border-transparent flex items-center rounded-3xl">
                            <div className="ml-4 sm:ml-24 md:ml-24 md:text-left leading-10 h-72 w-fit">
                                <p className="text-primaryText ssm:text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-semibold -ml-1 sm:text-center md:te">{slide.text1}</p>
                                <p className="text-primaryText ssm:text-3xl sm:text-5xl lg:text-6xl xl:text-7xl font-semibold -ml-1">{slide.text2}</p>
                                <p className="text-[#7E7E7E] mt-6 md:text-lg lg:text-xl">{slide.save}</p>
                                <div className="bg-white mt-6 md:mt-6 ssm:w-[19rem] sm:w-full h-16 rounded-full flex items-center">
                                    ...
                                    <button className="bg-primary h-16 rounded-full text-white ssm:hidden sm:block sm:w-24 md:w-32 ml-2 md:ml-0">{slide.subscribe}</button>
                                </div>
                            </div>
                        </div>
                    </div>
